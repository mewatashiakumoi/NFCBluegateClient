package com.somethinkapps.bluegateclient;
...
import com.somethinkapps.bluegateclient.R;
...
public class MainActivity extends Activity {
	...
	//	Toast.makeText(this, name, Toast.LENGTH_LONG).show();
        ...
        TextView mName = (TextView) findViewById(R.id.textView_status);
    	String mac = BluetoothAdapter.getDefaultAdapter().getAddress();
        mName.setText("Hello, "+mac);
  ...
  //      mOutEditText.setOnEditorActionListener(mWriteListener);
        ...
        guideButton = (Button) findViewById(R.id.button_guide);
        guideButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
            Toast.makeText(MainActivity.this, "Penggunaan Aplikasi: \n1.Klik tombol menu\n2.Klik Secure/Insecure Connection\n3.Cari Gate Server\n4.Tunggu hingga koneksi\n5.Tekan Send\n6.Tunggu hingga gerbang terbuka", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_WRITE:
                ...
                String writeMessage = "Sent Request";
